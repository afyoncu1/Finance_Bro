...
const Logo: React.FC<LogoProps> = ({ className = "h-12" }) => {
  return (
    <svg viewBox="0 0 1024 1024" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="512" y="820" fontFamily="system-ui, -apple-system, sans-serif" fontSize="140" fontWeight="900" fill="#0C3B4D" textAnchor="middle">Finance</text>
      <text x="512" y="940" fontFamily="system-ui, -apple-system, sans-serif" fontSize="180" fontWeight="900" fill="#0C3B4D" textAnchor="middle">Bro</text>
    </svg>
  );
};
